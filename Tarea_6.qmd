...
def f(t, U):
    y, y_prime = U
    return [y_prime, -0.5*y_prime - 4*y]
...
def f(t, U):
    y, y_prime = U
    return [y_prime, -2*y_prime - y + np.cos(t)]
...
edo_sol = integrate.solve_ivp(f, [t0, tf], U0, t_eval=t_values)
...
t0 = 0
tf = 2
valores_iniciales = [35, 25]
t_valores = np.linspace(t0, tf, 500)


edo_sol = integrate.solve_ivp(f, [t0, tf], valores_iniciales, t_eval=t_valores)


plt.figure(figsize=(12, 6))
plt.plot(edo_sol.t, edo_sol.y[0], label='x(t)', color='blue', linewidth=2)
plt.plot(edo_sol.t, edo_sol.y[1], label='y(t)', color='red', linewidth=2)
plt.title('Soluciones Individuales del Sistema ', fontsize=14)
plt.xlabel('Tiempo t', fontsize=12)
plt.ylabel('Valores de x(t) e y(t)', fontsize=12)
...
plt.plot(edo_sol.y[0], edo_sol.y[1], color='purple', linewidth=2)
plt.scatter(valores_iniciales[0], valores_iniciales[1], color='green', 
           label='Condición inicial', zorder=5)
plt.title('Trayectoria del Sistema (Espacio de Fase)', fontsize=14)
...
t0 = 0
tf = 10
valores_iniciales = np.array([7, 3])
t_valores = np.linspace(t0, tf, 500)
...
plt.figure(figsize=(12, 6))
plt.plot(edo_sol.t, edo_sol.y[0], label='x(t): Especie 1', color='blue', linewidth=2)
plt.plot(edo_sol.t, edo_sol.y[1], label='y(t): Especie 2', color='red', linewidth=2)
plt.title('Soluciones Individuales del Sistema ', fontsize=14)
plt.xlabel('Tiempo t', fontsize=12)
...
t0 = 0
tf = 10  
t_valores = np.linspace(t0, tf, 1000) 


sol = integrate.solve_ivp(sistema, [t0, tf], X0, 
                         t_eval=t_valores)
...
plt.subplot(1, 2, 1)
plt.plot(sol.t, sol.y[0], 'b-', label='x(t)', linewidth=2)
plt.plot(sol.t, sol.y[1], 'r--', label='y(t)', linewidth=2)
plt.title('Evolución Temporal del Sistema No Autónomo', fontsize=14)
plt.xlabel('Tiempo t', fontsize=12)
plt.ylabel('Valores de x(t) e y(t)', fontsize=12)
plt.grid(True, linestyle='--', alpha=0.7)
plt.legend(fontsize=12)

# Gráfico de trayectoria en espacio de fases
plt.subplot(1, 2, 2)
plt.plot(sol.y[0], sol.y[1], 'purple', linewidth=1.5, 
         label='Trayectoria del sistema')
plt.scatter(X0[0], X0[1], color='green', s=100, 
            label='Condición inicial (1, -1)')
plt.title('Diagrama de Fase: y vs x', fontsize=14)
plt.xlabel('x(t)', fontsize=12)
plt.ylabel('y(t)', fontsize=12)
plt.grid(True, linestyle='--', alpha=0.7)
plt.legend(fontsize=12)
