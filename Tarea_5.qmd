...
#Grafica de errores de la segunada derivada
...
fig = go.Figure()
fig.add_trace(go.Scatter(x= x_values, y= derf(x_values), mode='lines', name='Derivada', line=dict(color='goldenrod', width=2.5)))
fig.add_trace(go.Scatter(x= x_values, y= df_01(x_values), mode='lines', name='h=0.1', line=dict(color='teal', width=1.8)))
fig.add_trace(go.Scatter(x= x_values, y= df_025(x_values), mode='lines', name='h=0.25', line=dict(color='royalblue', width=1.5)))

fig.add_trace(go.Scatter(x= x_values, y= derivative(f, x_values).df, mode='lines', name='SciPy', line=dict(color='aqua', width=1.7)))
fig.add_trace(go.Scatter(x= x_values, y= derf(x_values), mode='lines', name='Derivada', line=dict(color='goldenrod', width=1)))
...
#Grafica de errores de la derivada
...
#Grafica de errores segunda derivada
...
# Función de numdifftools
df_075 = nd.Derivative(f, step=0.75, method='central', order=2)
df_015 = nd.Derivative(f, step=0.15, method='central', order=2)

fig = go.Figure()
fig.add_trace(go.Scatter(x= x_values, y= derf(x_values), mode='lines', name='Derivada', line=dict(color='goldenrod', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= df_075(x_values), mode='lines', name='h=0.75', line=dict(color='teal', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= df_015(x_values), mode='lines', name='h=0.15', line=dict(color='royalblue', width=1)))
...
fig.add_trace(go.Scatter(x= x_values, y= abs(derf(x_values)-df_075(x_values)), mode='lines', name='h=0.75', line=dict(color='royalblue', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= abs(derf(x_values)-df_015(x_values)), mode='lines', name='h=0.15', line=dict(color='teal', width=1)))
...
ddf_075 = nd.Derivative(f, step=0.75, method='central', order=2, n = 2)
ddf_015 = nd.Derivative(f, step=0.15, method='central', order=2, n = 2)
fig = go.Figure()

x_values = np.linspace(a, b, 500)

fig.add_trace(go.Scatter(x= x_values, y= ddf_075(x_values), mode='lines', name='h=0.75', line=dict(color='royalblue', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= ddf_015(x_values), mode='lines', name='h=0.15', line=dict(color='teal', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= dderf(x_values), mode='lines', name='2da. derivada', line=dict(color='goldenrod', width=1)))
...
fig.add_trace(go.Scatter(x= x_values, y= abs(dderf(x_values)-ddf_015(x_values)), mode='lines', name='h=0.15', line=dict(color='royalblue', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= abs(dderf(x_values)-ddf_075(x_values)), mode='lines', name='h=0.75', line=dict(color='teal', width=1)))
...
#Para hacer la grafica y encontrar el area bajo la curva no lo hice hasta infinito lo hice a 2.5 ya que apartir de ahi parece una linea cercana a 0
...
plt.figure(figsize=(8,6))
plt.plot(x_values,f(x_values), label="Función")
plt.fill_between(np.linspace(a,b, 1000), y1=0, y2=f(np.linspace(a,b, 100)), color="green", alpha=0.5)
plt.grid()
#plt.axis("square")
plt.legend()
plt.show()
...
##Tome 8 ya que tiende a infinito y seria cercano a 0 el area en esa zona
...
plt.plot(x[puntos_in_positivo], y[puntos_in_positivo], 'o', color="magenta", label= "Puntos in +", alpha=0.5, markersize=2.5)
plt.plot(x[puntos_in_negativo], y[puntos_in_negativo], 'o', color="red", label= "Puntos in -", alpha=0.5, markersize=2.5)
plt.plot(x[puntos_out_positivo], y[puntos_out_positivo], 'o', color="blue", label= "Puntos out +", alpha=0.5, markersize=2.5)
plt.plot(x[puntos_out_negativo], y[puntos_out_negativo], 'o', color="skyblue", label= "Puntos out -", alpha=0.5, markersize=2.5)
plt.plot(x_values,f(x_values), color= "black", label="Función", linewidth=1.2)
...
plt.plot(x[puntos_in_positivo], y[puntos_in_positivo], 'o', color="limegreen", label= "Puntos in +", alpha=0.5, markersize=2.5)
plt.plot(x[puntos_in_negativo], y[puntos_in_negativo], 'o', color="red", label= "Puntos in -", alpha=0.5, markersize=2.5)
plt.plot(x[puntos_out_positivo], y[puntos_out_positivo], 'o', color="aqua", label= "Puntos out +", alpha=0.5, markersize=2.5)
plt.plot(x[puntos_out_negativo], y[puntos_out_negativo], 'o', color="skyblue", label= "Puntos out -", alpha=0.5, markersize=2.5)
plt.plot(x_values,f(x_values), color= "black", label="Función", linewidth=1.2)
plt.grid()
plt.legend()
...
print(f'La aproximación de la integral es: {integral[0]}, con un error aproximadamente de {integral[1]}')
```
...
print(f'El error absoluto es de :{error_absoluto}')
```
...
integral = integrate.dblquad(f, 0, 6, lambda x: 1, lambda x:5)
...
integral = integrate.dblquad(f, 1, np.e, lambda x: 0, lambda x: np.log(x))
print(f'La aproximación de la integral es: {integral[0]}, con un error aproximado de {integral[1]}')
```
...
plt.fill_between(x[(x >= a1) & (x <= b1)], pdf[(x >= a1) & (x <= b1)], color='blue', alpha=0.3)
plt.text(0, 0.1, f'P({a1} ≤ X ≤ {b1})\nIntegral: {integral[0]:.4f}\nCDF: {prob_cdf:.4f}', 
...
```{python}
integral = integrate.quad(norm.pdf, a1, b1, args=(mu, sigma))

print(f'La aproximación de la integral es: {integral[0]:.4f}, con un error aproximado de {integral[1]:.10f}')
```

#Metodo CDF
```{python}

prob_cdf = norm.cdf(b1, mu, sigma) - norm.cdf(a1, mu, sigma)
print(f'El valor obtenido por el método cdf es: {prob_cdf:.4f}')
```
